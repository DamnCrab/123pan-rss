/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 60d809e0ec57ab2787f41d1a02d0b7a5)
// Runtime types generated with workerd@1.20250617.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: string;
		pan123_client_id: string;
		pan123_client_secret: string;
		JWT_SECRET: string;
		admin_password: string;
		database: D1Database;
		RateLimitGeneral: RateLimit;
		RateLimitLogin: RateLimit;
		RateLimitRSSUpdate: RateLimit;
		RateLimitStrict: RateLimit;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "pan123_client_id" | "pan123_client_secret" | "JWT_SECRET" | "admin_password">> {}
}
